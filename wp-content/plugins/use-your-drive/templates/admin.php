    ...
    <div class="wrap">
      ...
      <div class="useyourdrive-panel useyourdrive-panel-right">
        ...
        <div id="settings_general" class="useyourdrive-tab-panel current">
          ...
          // SALE
          if (time() < strtotime('2018-11-27 00:00:00')) {
              ?>
              <div class="useyourdrive-option-title"><?php echo 'Cyber Monday Sale! 50% off plugins, WordPress themes & more!'; ?></div>
              <a href="https://1.envato.market/c/1260925/275988/4415?u=https%3A%2F%2Fenvato.com%2Fcybermonday%2Fcode" target="_blank"><img src="<?php echo USEYOURDRIVE_ROOTPATH; ?>/css/images/cyber-monday-sale.jpg" alt="50% off code & plugins to enhance your website"/></a>
              <?php
          }
          ?>
        </div>
