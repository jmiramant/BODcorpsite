  ...
  jQuery(function ($) {
    ...
    $('.UseyourDrive.media.video').each(function () {
      ...
      uyd_playlists[listtoken] = new jPlayerPlaylist({
        ...
        setmedia: function (e) {
          $(".UseyourDrive[data-token='" + listtoken + "'] .jp-video-play").hide();
        },
        ready: function (e) {
          $(".UseyourDrive[data-token='" + listtoken + "'] .jp-title").show();
          var data = {
          ...
          $(".UseyourDrive[data-token='" + listtoken + "'] object").height($(".UseyourDrive[data-token='" + listtoken + "'] .jp-jplayer").height() - 50);
          $(".UseyourDrive[data-token='" + listtoken + "'] .jp-video-play").height($(".UseyourDrive[data-token='" + listtoken + "'] .jp-jplayer").height() - 50);
        ...
        loadedmetadata: function (e) {
          ...
          if (e.jPlayer.status.videoHeight !== 0 && e.jPlayer.status.videoWidth !== 0) {
            ...
            if ($(".UseyourDrive[data-token='" + listtoken + "'] .jp-jplayer img").attr('src').indexOf("/css/images/audiothumb.png") >= 0) {
              $(".UseyourDrive[data-token='" + listtoken + "'] .jp-jplayer img").hide();
            }
          }

          if (e.jPlayer.status.paused) {
            $(".UseyourDrive[data-token='" + listtoken + "'] .jp-video-play").show();
          }
        },
        waiting: function (e) {
          var videoselector = $(".UseyourDrive[data-token='" + listtoken + "'] object");
