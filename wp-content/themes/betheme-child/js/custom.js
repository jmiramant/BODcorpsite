...
(function($) {
  ...
  function setEqualHeight() {
    if (jQuery(window).width() >= 768) {
      jQuery('.where-we-work-block ul').equalHeights();
      jQuery('.phase-1-row .icon_box').equalHeights();
      jQuery('.phase-2-row .icon_box').equalHeights();
      jQuery('.phase-3-row .icon_box').equalHeights();
      jQuery('#approach-section .icon_box').equalHeights();
      jQuery('.entry-content .leaders .desc_wrapper').equalHeights();
    }
  }
  $(document).ready(function() {
    setEqualHeight();
    jQuery('.page-template-template-case-study  .main-article .article-inner').equalHeights();
    jQuery('.page-template-template-case-study  .detail-recent-box  .detail-recent-box-inner').equalHeights();
  });
...
jQuery(document).ready(function($) {
  if (jQuery('.service-custom-tab').length) {
    ...
    jQuery('body').on('click', ".menu-item a", function() {
      ...
      if (id == 'visualization') {
        setTimeout(function(){
          jQuery(".service-custom-tab #phase-2").trigger( "click");
        }, 1000);
        jQuery('html, body').animate({
            scrollTop: jQuery(".service-custom-tab").offset().top - 100
        }, 2000);
      }else if(id == 'analytics') {
        setTimeout(function(){
          jQuery(".service-custom-tab #phase-3").trigger( "click");
        }, 1000);
        jQuery('html, body').animate({
            scrollTop: jQuery(".service-custom-tab").offset().top - 100
        }, 2000);
        ...
        setTimeout(function(){
          jQuery(".service-custom-tab #phase-1").trigger( "click");
        }, 1000);
        jQuery('html, body').animate({
            scrollTop: jQuery(".service-custom-tab").offset().top - 100
        }, 2000);
    ...
    if (id == 'visualization') {
      ...
      jQuery('.service-custom-tab li:first-child').addClass('active');
    }


  }

  jQuery('body').on('click', ".service-custom-tab-nav .phase-1", function() {
    jQuery(".service-custom-tab #phase-1")[0].click();
    jQuery('html, body').animate({
        scrollTop: jQuery(".service-custom-tab").offset().top - 100
    }, 2000);
  });

  jQuery('body').on('click', ".service-custom-tab-nav .phase-2", function() {
    jQuery(".service-custom-tab #phase-2")[0].click();
    jQuery('html, body').animate({
        scrollTop: jQuery(".service-custom-tab").offset().top - 100
    }, 2000);
  });
  jQuery('body').on('click', ".service-custom-tab-nav .phase-3", function() {
    jQuery(".service-custom-tab #phase-3")[0].click();
    jQuery('html, body').animate({
        scrollTop: jQuery(".service-custom-tab").offset().top - 100
    }, 2000);
  });
  ...
  jQuery('.phase-2-row').hide();
  jQuery('.phase-3-row').hide();

  jQuery('body').on('click', '.service-custom-tab li', function() {
    jQuery('.service-custom-tab li').removeClass('active');
    jQuery(this).addClass('active');

  });
  jQuery('body').on('click', '.service-custom-tab #phase-1', function() {
    jQuery('.phase-1-row').show();
    jQuery('.phase-2-row').hide();
    jQuery('.phase-3-row').hide();
  });

  jQuery('body').on('click', '.service-custom-tab #phase-2', function() {
    jQuery('.phase-1-row').hide();
    jQuery('.phase-2-row').show();
    jQuery('.phase-3-row').hide();
  });

  jQuery('body').on('click', '.service-custom-tab #phase-3', function() {
    jQuery('.phase-1-row').hide();
    jQuery('.phase-2-row').hide();
    jQuery('.phase-3-row').show();
  });
...
jQuery(document).ready(function() {
  ...
  $("#menu-main-menu > li.menu-item > ul.sub-menu").each(function(){
    ...
    if (submenu.find('.lft-sub-mnu').is(':empty')) {
      submenu.find('.lft-sub-mnu').remove();
    }
    if (submenu.find('.rit-sub-mnu').is(':empty')) {
      submenu.find('.rit-sub-mnu').remove();
    }
    submenu.addClass(submenu.find('div').length + 'div');
