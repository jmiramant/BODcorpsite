	...
	<div class="blog-left">
		...
		<div class="blog-right">
			...
			<ul>
				...
				?>
				<li><a href="<?php echo $cat_slug; ?>" class="<?php echo $category->slug == $term->slug? 'active' : '';  ?>"><span class="span-left"><?php echo $category->name;  ?></span><span> <?php echo $category->category_count;  ?></span></a></li>
				<?php
						}
					}
				?>
