...
<form class="jobpost-form" id="sjb-application-form" name="c-assignments-form"  enctype="multipart/form-data">
    ...
    <div class="row">
            ...
            foreach ($keys as $key):
                if (substr($key, 0, 7) == 'jobapp_'):
                    ...
                    switch ($val['type']) {
                        ...
                        case 'dropdown':
                            if ($val['options'] != '') {
                                echo '<div class="col-md-4 howtohearTitle">'
                                . '<label for="' . $key . '">' . $label . $required_field_asterisk . '</label>'
                                . '</div>'
                                . ' <div class="col-md-8">'
                                . '<div class="form-group">'
                                . '<select class="form-control select-control" name="' . $name . '" id="' . $id . '" ' . $is_required . '>';
                                $options = explode(',', $val['options']);
                                foreach ($options as $option) {
        ...
        $sjb_attach_resume = '<div class="col-md-3 fileUpTitle">'
                ...
                if (0 < $total_sections) {
                    ...
                    <div class="form-group ">
                        ...
                        <?php if ($term_conditions_label) { ?>
                            ...
                            <div class="col-md-8 checkboxCol">
                                <div id="jobapp-tc">
