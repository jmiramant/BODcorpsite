...
get_header(); ?>
<style>
.single-jobpost #Top_bar .menu>li>a {
    color: #0a3d5c !important;
}
@media(min-width:768px) {
    .single-jobpost #Top_bar #logo .logo-main.scale-with-grid {
        display: none;
    }
    .single-jobpost #Top_bar #logo .logo-sticky.scale-with-grid {
        display: block;
    }
}
@media (max-width:767px){
.sngleJobHeroHeader { margin-top: 0; }
}
</style>
<div class="sngleJobHeroHeader"><h1><?php the_title(); ?></h1></div>
<?php ob_start();
global $post;
...
================================================== -->
<div class="sjb-page job-text-sec">
